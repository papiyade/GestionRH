                ...
                <div class="card" id="company-overview">
                            ...
                            <div class="avatar-title bg-light rounded">
                                @if ($user->profile_photo_path)
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('storage/' . $user->profile_photo_path) }}" alt="Header Avatar">
                                @else
                                    <div class="avatar-lg">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-borderless mb-4">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="overview-industryType">{{ $user->contract_type }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="overview-company_location">{{ $user->adresse }}</td>
                                    </tr>
                                    <tr>
                                        <td class="fw-medium" scope="row">Score de Performance</td>
                                        <td><span class="overview-rating">{{ $user->performance_score }}</span> <i
                                                class="ri-star-fill text-warning align-bottom"></i></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-medium" scope="row">Horaire de travail</td>
                                        <td>
                                            <span class="overview-website">{{ $user->work_schedule }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="hstack gap-3">
                            <button type="button" class="btn btn-soft-success custom-toggle w-100 material-shadow-none"
                                data-bs-toggle="button">
                                <a class="icon-on"><i class="ri-pencil-line align-bottom me-1"></i> Modifier</a>
                            </button>
                            <a href="{{ route('users.show', $user->id) }}" class="btn btn-primary w-100">Voir le profil <i
                                    class="ri-arrow-right-line align-bottom"></i></a>
                            <a href="#!" class="btn btn-danger w-100">Bloquer le compte <i
                                    class="ri-trash align-bottom"></i></a>
                        </div>
                    </div>
                </div>
            </div>
