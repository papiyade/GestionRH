                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarIcons">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="entreprise.employes" class="nav-link" data-key="t-line-awesome">Liste des utilisateurs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"> <span data-key="t-crypto-svg">Ajouter un nouvel utilisateur</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
