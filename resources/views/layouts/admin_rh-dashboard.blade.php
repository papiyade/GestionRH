...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 20:12:39 GMT -->
<head>

    <meta charset="utf-8" />
    <title>Farlu |Dashboard Admin </title>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('rh_dashboard') }}"  role="button" aria-expanded="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarIcons">
                                <i class="ri-account-circle-line"></i> <span data-key="t-icons">Employes</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarIcons">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('employeList') }}" class="nav-link" data-key="t-line-awesome">Liste des employes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('rh.users.create') }}" class="nav-link"> <span data-key="t-crypto-svg">Ajouter un nouveau employe</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ route('teams') }}" class="nav-link" data-key="t-alerts">Liste des équipes</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 20:14:14 GMT -->
</html>
