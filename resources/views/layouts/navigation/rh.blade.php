...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('template/html/template/assets/img/favicon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/simplebar/simplebar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('template/html/template/assets/css/style.css') }}">
    <script src="{{ asset('template/html/template/assets/js/theme-script.js') }}"></script>
...
<!-- Fontawesome CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/fontawesome/css/fontawesome.min.css') }}">
<link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/fontawesome/css/all.min.css') }}">

<!-- Tabler Icon CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/tabler-icons/tabler-icons.min.css') }}">

<!-- Datatable CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/css/dataTables.bootstrap5.min.css') }}">

<!-- Select2 CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/select2/css/select2.min.css') }}">

<!-- Simplebar CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/plugins/simplebar/simplebar.min.css') }}">

<!-- Main CSS -->
<link rel="stylesheet" href="{{ asset('template/html/template/assets/css/style.css') }}" id="app-style">


    <style>
        /* Fix pour le scroll du sidebar uniquement */
        .sidebar-inner {
...
<script src="//cdn.datatables.net/plug-ins/1.13.6/i18n/fr-FR.json"></script>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <span class="logo-light">
                            <span class="logo-lg"><img src="{{ asset('template/html/template/assets/img/logo.svg') }}" alt="logo"></span>
                            <span class="logo-sm"><img src="{{ asset('template/html/template/assets/img/logo-small.svg') }}" alt="small logo"></span>
                        </span>

                        <!-- Logo Dark -->
                        <span class="logo-dark">
                            <span class="logo-lg"><img src="{{ asset('template/html/template/assets/img/logo-white.svg') }}" alt="dark logo"></span>
                        </span>
                    </a>
                   ...
                   <div class="header-item">
                        <div class="dropdown me-2">
                            <button class="topbar-link btn" data-bs-toggle="dropdown" data-bs-offset="0,24" type="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{ asset('template/html/template/assets/img/flags/us.svg') }}" alt="Language" height="16">
                            </button>
                            
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('template/html/template/assets/img/flags/us.svg') }}" alt="" class="me-1" height="16"> <span class="align-middle">English</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('template/html/template/assets/img/flags/de.svg') }}" alt="" class="me-1" height="16"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('template/html/template/assets/img/flags/fr.svg') }}" alt="" class="me-1" height="16"> <span class="align-middle">French</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('template/html/template/assets/img/flags/ae.svg') }}" alt="" class="me-1" height="16"> <span class="align-middle">Arabic</span>
                                </a>
                            </div>
                        </div>
                    </div>
							...
							<div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
								...
								<div class="notification-body position-relative z-2 rounded-0" data-simplebar>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
                                                <img src="{{ asset('template/html/template/assets/img/users/avatar-2.jpg') }}" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
												<p class="mb-0 fw-medium text-dark">Daniel Martinz</p>
												<p class="mb-1 text-wrap">
													<span class="fw-medium text-dark">Daniel Martinz</span> requested Sick Leave from May 28 2025 to May 29 2025
												</p>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="{{ asset('template/html/template/assets/img/users/user-02.jpg') }}" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="{{ asset('template/html/template/assets/img/users/user-04.jpg') }}" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="{{ asset('template/html/template/assets/img/users/user-24.jpg') }}" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
           ...
           <div class="sidebar-logo">
                <div>
                    ...
                    <a href="index.html" class="logo logo-normal">
                        <img src="{{ asset('template/html/template/assets/img/logo.svg') }}" alt="Logo">
                    </a>

                    <!-- Logo Small -->
                    <a href="index.html" class="logo-small">
                        <img src="{{ asset('template/html/template/assets/img/logo-small.svg') }}" alt="Logo">
                    </a>

                    <!-- Logo Dark -->
                    <a href="index.html" class="dark-logo">
                        <img src="{{ asset('template/html/template/assets/img/logo-white.svg') }}" alt="Logo">
                    </a>
                </div>
    ...
    <form method="POST" action="{{ route('logout') }}" class="m-0">
        ...
        <button type="submit" class="btn btn-danger w-100">
            <i class="ti ti-logout-2 me-1"></i> Déconnexion
        </button>
    </form>
</div>
    ...
    <!-- Simplebar JS -->
    <script src="{{ asset('template/html/template/assets/plugins/simplebar/simplebar.min.js') }}"></script>
...
<!-- Select2 JS -->
<script src="{{ asset('template/html/template/assets/plugins/select2/js/select2.min.js') }}"></script>

<!-- Datatable JS -->
<script src="{{ asset('template/html/template/assets/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('template/html/template/assets/js/dataTables.bootstrap5.min.js') }}"></script>
