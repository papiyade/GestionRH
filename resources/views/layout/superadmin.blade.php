							...
							<div class="me-1 notification_item">
								...
								<div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
									...
									<div class="d-flex p-0">
										...
										<a href="https://smarthr.co.in/demo/html/template/activity.html" class="btn btn-primary w-100">Voir tout</a>
									</div>
								</div>
							</div>
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<ul>
								<li class="">
									<a href="{{route('superadmin')}}" class="active subdrop">
						...
						<li>
							<ul>
								<li class="submenu">
									<a href="#">
										<i class="ti ti-user-shield"></i><span>Administrateurs</span>
                                        <span class="menu-arrow"></span>
									</a>

                                    <ul>
										<li><a href="{{ route("list_admin") }}">Liste des admins</a></li>
										<li><a href="{{ route('add_admin_view') }}">Créer un nouvel admin</a></li>
									</ul>
								</li>
								<li>
									<a href="{{route('entreprises.list')}}">
										<i class="ti ti-building"></i><span>Entreprises</span>
									</a>
								</li>
							</ul>
						</li>
