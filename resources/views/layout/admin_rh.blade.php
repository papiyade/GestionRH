...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            <div class="main-header">
                ...
                <div class="header-left">
                    <a href="{{ route('rh_dashboard') }}" class="logo">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <a href="{{ route('rh.index') }}"
                                                        class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
                                                        <span class="d-flex align-items-center me-3">
                                                            <i class="ti ti-activity text-default me-2"></i>Fiches
                                                            salariéss
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <a href="{{ route('candidatures.index') }}"
                                                        ...
                                                        <span class="d-flex align-items-center me-3">
                                                            <i
                                                                class="ti ti-user-check text-default me-2"></i>Candidatures
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                </div>
                            ...
                            <div class="dropdown me-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div class="card mb-0 border-0 shadow-none">
                                        ...
                                        <div class="card-body">
                                            <a href="{{ route('employeList') }}" class="linkdark d-block pb-2">
                                                <span class="avatar avatar-md bg-transparent-dark me-2"><i
                                                        class="ti ti-calendar text-gray-9"></i></span>Employés
                                            </a>
                                            <a href="{{ route('teams') }}" class="linkdark d-block py-2">
                                                <span class="avatar avatar-md bg-transparent-dark me-2"><i
                                                        class="ti ti-subtask text-gray-9"></i></span>Equipes </a>
                                            <a href="{{ route('candidatures.index') }}"
                                                class="linkdark d-block py-2">
                                                <span class="avatar avatar-md bg-transparent-dark me-2"><i
                                                        class="ti ti-notes text-gray-9"></i></span>Candidatures
                                            </a>
                                            <a href="{{ route('rh.index') }}" class="linkdark d-block py-2">
                                                <span class="avatar avatar-md bg-transparent-dark me-2"><i
                                                        class="ti ti-notes text-gray-9"></i></span>Fiches salariés
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if (Auth::user()->profile_photo_path)
                                    <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                                        ...
                                        <img class="rounded-circle header-profile-user"
                                            src="{{ asset(Auth::user()->profile_photo_path) }}" width="40"
                                            height="40" alt="Header Avatar">
                                    </a>
                                @else
                                    <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                                        data-bs-toggle="dropdown">
                                        ...
                                        <div class="card-header">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="fs-12 fw-medium mb-0"><a>{{ Auth::user()->email }}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <ul>
                                <li>
                                    <a href="{{ route('rh_dashboard') }}"
                                        class="{{ request()->routeIs('rh_dashboard') ? 'active' : '' }}">
                        ...
                        <li>
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('employeList') }}"
                                        class="{{ request()->routeIs('employeList') ? 'active' : '' }}">
                                ...
                                <!-- Équipes -->
                                <li class="submenu {{ request()->is('teams*') ? 'active' : '' }}">
                                    <a href="{{ route('teams') }}">
                                        <i class="ti ti-users-group"></i><span>Équipes</span>
                                    </a>
                                </li>

                                <!-- Candidatures -->
                                <li
                                    class="submenu {{ request()->is('candidatures*') || request()->is('offres*') ? 'active' : '' }}">
                                    <a href="#">
                                        <i class="ti ti-file-check"></i><span>Candidatures</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <ul>
                                        <li><a href="{{ route('offres.index') }}"
                                                class="{{ request()->routeIs('offres.index') ? 'active' : '' }}">Liste
                                                des offres</a></li>
                                        <li><a href="{{ route('candidatures.index') }}"
                                                class="{{ request()->routeIs('candidatures.index') ? 'active' : '' }}">Suivi
                                                des candidatures</a></li>
                                    </ul>
                                </li>

                                <!-- Gestion des salaires -->
                                <li
                                    class="submenu {{ (request()->is('rh') || request()->is('rh/index*')) && !request()->is('rh/users*') && !request()->is('rh/prestataires*') && !request()->routeIs('rh_dashboard') ? 'active' : '' }}">
                                    <a href="#">
                                        <i class="ti ti-coin"></i><span>Fiches de salaires</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <ul>
                                        <li><a href="{{ route('rh.index') }}"
                                                class="{{ request()->routeIs('rh.index') ? 'active' : '' }}">Fiches
                                                employés</a></li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('rh.prestataires.index') }}"
                                        class="{{ request()->routeIs('rh.prestataires.*') ? 'active' : '' }}">
                                        <i class="ti ti-briefcase"></i><span>Prestataires</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="footer d-sm-flex align-items-center justify-content-between border-top bg-white p-3">
                ...
                <p> By <a href="javascript:void(0);" class="bbs text-primary">BBS MASTER GROUP</a></p>
            </div>
    ...
    <!-- jQuery -->
    <script data-cfasync="false" src="https://smarthr.co.in/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js">
    </script>
