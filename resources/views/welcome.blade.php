...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gradient-to-r from-orange-500 to-orange-900 animate-gradient">
        <header class="bg-gradient-to-r from-orange-500 via-orange-900 to-black animate-gradient animate-fade-in shadow">
        ...
        <div class="h-screen flex items-center bg-gradient-to-r from-orange-500 via-orange-900 to-black animate-gradient animate-fade-in">
        ...
        <section class="bg-gradient-to-r from-orange-500 via-orange-900 to-black py-16">
        ...
        <section class="bg-gradient-to-r from-orange-500 via-orange-900 to-black py-16" id="fonctionnalités">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
        ...
        <section class="bg-gradient-to-r from-orange-500 via-orange-900 to-black py-16" id="a-propos">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
                À propos de nous
        ...
        <section class="bg-gradient-to-r from-orange-500 via-orange-900 to-black py-16" id="pricing">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
                Nos Offres
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 bg-gradient-to-r from-orange-500 to-orange-900 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                ...
                <div class="mt-6 text-center">
                    <a href="#" class="px-4 py-2 bg-white text-orange-500 rounded-md hover:bg-gray-200 transition duration-300">Souscrire</a>
                </div>
                </div>
                <div class="p-6 bg-gradient-to-r from-orange-500 to-orange-900 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
