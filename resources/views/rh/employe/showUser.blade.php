                ...
                <div class="card" id="company-overview">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted overview-industryType">
                                {{ optional($user->teams->first())->name ?? 'Aucune équipe' }}</p>
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-4 overview-companydesc">
                            {{ optional($user->teams->first())->description ?? 'Aucune description' }}</p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="overview-industryType">
                                            {{ $user->employeeDetail?->type_contrat ?? 'Pas encore défini' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="overview-company_location">
                                            {{ $user->employeeDetail?->adresse ?? 'Pas encore défini' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="overview-website">{{ $user->employeeDetail?->description_poste ?? 'Pas encore défini' }}</span>
                                        </td>
                                    </tr>
                                </tbody>
