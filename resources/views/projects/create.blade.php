    ...
    <div class="flex justify-center">
        <div class="w-full max-w-md">
            <div class="bg-white shadow-md rounded-lg">
                <div class=" text-gray-900 p-4 rounded-t-lg">
                    <h1 class="text-center text-xl font-bold">Créer un Projet</h1>
                </div>
                <div class="p-6">
                    <form action="{{ route('projects.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <input type="text" class="form-control flex-1 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="title" name="title" required>
                                <svg class="w-5 h-5 ml-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="description" name="description" rows="4"></textarea>
                        </div>
                        <div class="mb-4">
                            <label for="team_id" class="block text-gray-700 text-sm font-bold mb-2">Équipe</label>
                            <div class="flex items-center">
                                <select class="form-control w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="team_id" name="team_id" required>
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Créer</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <form class="row" action="{{ route('projects.store') }}" method="POST">
                        @csrf
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label" for="project-title-input">Titre du projet </label>
