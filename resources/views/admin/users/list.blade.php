                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="customer_name">{{ $employe->name }}</td>
                                    <td class="email">{{ $employe->email }}</td>
                                    <td class="phone">{{ $employe->telephone ?? 'N/A' }}</td>
                                    <td class="address">{{ $employe->role ?? 'N/A' }}</td>
                                    <td>
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-0">Nous avons recherché plus de{{ $employes->count() }}+ utilisateurs et Nous n’avons trouvé aucun utilisateur pour votre recherche.</p>
                            </div>
                        </div>
                    </div>
