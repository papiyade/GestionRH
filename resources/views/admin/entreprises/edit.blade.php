    ...
    <div class="container my-5">
        <div class="card shadow-lg border-0 rounded-4">
            <div class="card-body p-5">
                ...
                <form id="entrepriseForm" action="{{ route('entreprise.update', $entreprise->id) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="card d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3">
                                <div
                                    class="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-dashed me-2 flex-shrink-0 text-dark frames">
                                    @if ($entreprise->logo_path)
<img src="{{ asset($entreprise->logo_path) }}"
     alt="Logo entreprise"
     class="rounded-circle img-resources"
     style="object-fit:cover;">
                                ...
                                <div class="profile-upload">
                                    <div class="mb-2">
                                        ...
                                        <p class="fs-12">L’image doit être inférieure à 4 Mo (formats acceptés : JPG, PNG,
                                            JPEG)</p>
                                    </div>
                                    ...
                                    <div class="profile-uploader d-flex align-items-center">
                                        <div class="drag-upload-btn btn btn-sm btn-primary me-2">
                                            Choisir une image
                                            <input type="file" class="form-control image-sign" name="logo_path"
                                                accept="image/*">
                                        </div>
                                    ...
                                    @if ($entreprise->logo_path)
                                        <div class="mt-3 mx-auto">
                                            <img src="{{ asset($entreprise->logo_path) }}" alt="Logo actuel"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="entreprise_name"
                                    value="{{ old('entreprise_name', $entreprise->entreprise_name) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Adresse email professionnelle <span
                                        class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="email"
                                    value="{{ old('email', $entreprise->email) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Description de l'entreprise <span
                                        class="text-danger">*</span></label>
